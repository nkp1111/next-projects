        ...
        <form className="bg-white shadow-lg p-4 rounded-2 mt-2"
          ...
          <div className="row">
                      ...
                      {courseData.classes.map((classD, ind) => {
                        if (typeof classD === "string") {
                          return <li key={ind} className='mb-2'>
                            <span>{classD}</span>
                            <span className='ms-4 fw-bold btn btn-danger' onClick={() => removeClass(ind)}>X</span>
                          </li>
                        } else {
                          return <li key={ind} className='mb-2'>
            ...
            <fieldset className='col-md-6 col-12'>
              ...
              <button type="button" className='btn btn-success' onClick={addClass}>Add Class</button>
            </fieldset>
          </div>
